...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYjMzYmwzYnJveDQyIiwiYSI6ImNrOXRzOWI4dTA3MTUzaG5vNmM4MzRhd20ifQ.2OGqwt7eIYZRmVt0Ut3W3Q';
  var map = new mapboxgl.Map({
    container: 'map',
    // put the map on an element with id of 'map'.
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              ...
              window.setTimeout(function () {
                location.assign('/');
              }, 1); // Alert and then after 1 msecs, go back to the overview page.
            }
...
var stripe = Stripe('pk_test_GdDRf2kR41EDfz0h6qq2JixD00ZFaNUsCa');
...
if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // we stored the data of locations in the div with an id of map. Now, we have retrieved it from the dataset.
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4916" + '/');
